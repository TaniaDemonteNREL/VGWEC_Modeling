function [t,excIRF] = getExcitationIRFfromBEMIO(varargin,plotFlag,rho,g)
...
t = X.X1; 
excIRF.Surge = squeeze(Y.Y1(1,1,:)) * rho * g;  % Surge
excIRF.Heave = squeeze(Y.Y1(2,1,:)) * rho * g;  % Heave
excIRF.Pitch = squeeze(Y.Y1(3,1,:)) * rho * g;  % Pitch
